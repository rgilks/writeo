...
def train_feedback_model():
    ...
    print("=" * 80)
    print("T-AES-FEEDBACK QUICK TEST (2 EPOCHS)")
    print("=" * 80)
    ...
    config = {
        ...
        "warmup_steps": 100,  # Reduced for quick test
        # ADJUSTED WEIGHTS (from implementation plan)
        "cefr_weight": 0.8,  # Down from 1.0
        "span_weight": 1.2,  # Up from 0.5
