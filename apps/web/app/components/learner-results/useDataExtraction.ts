...
interface ExtractedData {
  ...
  lowestDim: [string, number] | undefined;
...
export function useDataExtraction(data: AssessmentResults, submissionId?: string): ExtractedData {
  // Memoize the entire extraction to prevent recalculation on every render
  return useMemo(() => {
