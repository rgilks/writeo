...
from schemas import ModalRequest, ModalPart, ModalAnswer
...
def main():
    ...
    parser.add_argument(
        "--url",
        help="Remote endpoint URL (required for remote mode)"
    )
    parser.add_argument(
        "--api-key",
        help="API key for remote endpoint (required for remote mode)"
    )
    parser.add_argument(
        "--model",
        default="engessay",
        help="Model key to use (default: engessay)"
    )
    parser.add_argument(
        "--port",
        type=int,
