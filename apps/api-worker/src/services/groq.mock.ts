/**
 * Mock implementation of Groq API for testing
 * Returns deterministic responses to avoid API costs during tests
 */

export interface MockGroqResponse {
  content: string;
  usage?: {
...
/**
 * Mock Groq API call - returns deterministic responses based on input
 */
export async function mockCallGroqAPI(
  apiKey: string,
  modelName: string,
