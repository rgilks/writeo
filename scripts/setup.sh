...
echo ""
echo "Next steps:"
echo "1. Deploy Modal service: cd services/modal-essay && modal deploy app.py"
echo "2. Set Modal URL secret: cd apps/api-worker && $WRANGLER_CMD secret put MODAL_GRADE_URL"
